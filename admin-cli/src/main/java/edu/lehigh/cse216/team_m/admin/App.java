        ...
        while (true) {
            ...
            if (action == '?') {
                ...
                if (recieveBy.equals("A")) {
                    String table = getString(in, "Enter the input of the table you want to add");
                    String coloumn = getString(in, "Enter the input of the column you want to add");
                    db.alterTableAdd(table, coloumn);
                } else if (recieveBy.equals("B")) {
                    String table = getString(in, "Enter the input of the table you want to add");
                    String coloumn = getString(in, "Enter the input of the column you want to add");
